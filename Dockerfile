...
RUN apt update && apt install sudo vim less ack-grep rsync wget curl cmake iproute2 iw python3-pip python3-autopep8 libgeos-dev -y && rm -rf /var/lib/apt/lists/*
