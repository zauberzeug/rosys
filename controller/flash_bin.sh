...
esptool.py --chip esp32 --port /dev/ttyTHS1 --baud 921600 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 40m --flash_size detect 0x10000 zauberzeug-robot-brain.bin
