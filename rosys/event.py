...
class Id(Enum, init='value __doc__'):
    ...
    AUTOMATION_STARTED = auto(), 'triggered when an automation has been started'
    PAUSE_AUTOMATION = auto(), 'call this event to pause the currently running automation; provides a description of the cause as string parameter'
    STOP_AUTOMATION = auto(), 'call this event to stop the currently running automation; provides a description of the cause as string parameter'
    ...
    AUTOMATION_STOPPED = auto(), 'triggered when the automation has been stopped; provides a description of the cause as string parameter'
    AUTOMATION_FAILED = auto(), 'triggered when the automation has failed to complete; provides a description of the exception as string parameter'
