...
cmd = PlannerSearchCommand(
    ...
    obstacles=[],
    start=Pose(
        x=0.949818229371385, y=-1.3255930308634976, yaw=-2.8306211924025586, time=1657785359.4424448),
    goal=Pose(x=0.058508258883156763, y=-0.3466793684975241, yaw=3.141592653589793, time=0))
